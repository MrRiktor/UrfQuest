...
static internal class MessengerInternal
{
    ...
    static public void OnBroadcasting( string eventType, MessengerMode mode )
    {
        ...
        {
            Debug.LogWarning( string.Format( "Broadcasting message {0} but no listener found.", eventType ) );
        }
    }

    static public void CreateBroadcastSignatureException( string eventType )
    {
